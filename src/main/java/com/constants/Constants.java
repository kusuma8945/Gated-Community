...
public class Constants {
	...
	public static final String URL="jdbc:mysql://localhost:3306/VizagGatedCommunity";
	public static final String USERNAME="vizagapp";
	public static final String PASSWORD="Kusuma@123";
